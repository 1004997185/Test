...
<div class="row col-md-12 column">
	<form action="${pageContext.request.contextPath}/user/searchUser2" method="post">
	<span class="font">学号：</span>
	<input name="userNo" class="field" type="text" placeholder="请输入学号" value="${user.userNo}"/>&nbsp;&nbsp;
	<span class="font">姓名：</span>
	<input name="userName" class="field" type="text" placeholder="请输入姓名" value="${user.userName}"/>&nbsp;&nbsp;
    <span class="font">性别：</span>
    <input name="userSex" class="field" type="text" placeholder="请输入性别" value="${user.userSex}"/>&nbsp;&nbsp;
    <span class="font">班级：</span>
    <input name="gradeName" class="field" type="text" placeholder="请输入班级" value="${user.gradeName}"/>&nbsp;&nbsp;
    ...
    <nav aria-label="Page navigation" style="margin-left:34%">
			<ul class="pagination">
					<li><a href="${pageContext.request.contextPath}/user/allUser?page=1">首页</a></li>
					<c:if test="${page.hasPreviousPage }">
						<li><a href="${pageContext.request.contextPath}/user/allUser?page=${page.pageNum-1} "
					...
					<c:forEach items="${page.navigatepageNums }" var="page_Num">
						...
						<c:if test="${page_Num != page.pageNum }">
							<li><a href="${pageContext.request.contextPath}/user/allUser?page=${page_Num } ">${page_Num }</a></li>
						</c:if>
					...
					<li><a href="${pageContext.request.contextPath}/user/allUser?page=${page.pages}">末页</a></li>
			</ul>
	</nav>
